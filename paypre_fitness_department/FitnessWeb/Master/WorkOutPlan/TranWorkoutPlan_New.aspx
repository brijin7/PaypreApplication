<%@ Page Title="Work Out Plan Master" Language="C#" MasterPageFile="~/FitnessMstr.master" AutoEventWireup="true"
    CodeFile="TranWorkoutPlan_New.aspx.cs" Inherits="Master_WorkOutPlan_TranWorkoutPlan" %>
    ...
    <div class="container-fluid frmcontainer">
        ...
        <div id="DivForm" runat="server" visible="true">
                    ...
                    <div class="row">
                        <div id="dietPlanForm" runat="server" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 mb-3">
                                    <div class="txtboxdiv">
                                        <asp:TextBox ID="txtFromDate" CssClass="txtbox ConvertfromDate" TabIndex="1" runat="server" Enabled="false" placeholder=" " />
                                ...
                                <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 mb-3">
                                    <div class="txtboxdiv">
                                        <asp:TextBox ID="txtToDate" CssClass="txtbox ConverttoDate" TabIndex="2" runat="server" Enabled="false" placeholder=" " />
                        ...
                        <div id="divDietListView" runat="server" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12  table" visible="false">
                            <div  style="display:flex;    justify-content: space-between;">
                                  <span style=" font-size: 17px; color: forestgreen"><asp:Label ID="Label3" runat="server" Text="Diet Type"></asp:Label> : 
                                              <asp:Label ID="lblDietTYpe" runat="server" ></asp:Label></span>

                                 <span style=" font-size: 17px; color: forestgreen;"><asp:Label ID="Label10" runat="server" Text="Total Calories "></asp:Label> : 
                                              <asp:Label ID="lblTotalCalories" runat="server" ></asp:Label></span>
                            </div>
                                ...
                                <ItemTemplate>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="display: flex; font-size: 20px; color: black">
                                        <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-12 mb-2 ">
                                            ...
                                            <span style="font-size: 15px; color: black">  ( <asp:Label ID="lblfromTimes" runat="server" Text='<%#Bind("fromTime") %>'></asp:Label> - 
                                              <asp:Label ID="lbltoTimes" runat="server" Text='<%#Bind("toTime") %>' ></asp:Label>)</span>
            ...
            <div id="divWorkOutPlan" runat="server">
                <br />
                <div id="divWorkOutplanList" runat="server">
                    <asp:DataList ID="dtlWorkOutPlanList" runat="server" Width="60%">
                        <ItemTemplate>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 " style="display: flex; font-size: 20px; color: black">
                                <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-12 mb-2 ">

                                    <asp:LinkButton ID="btnworkingDay" Style="color: black" runat="server" Text='<%#Bind("workingDay") %>'></asp:LinkButton>
                                    <asp:Label ID="lblworkingDayId" runat="server" Text='<%#Bind("workingDayId") %>' Visible="false">  </asp:Label>

                                </div>
                                <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-12 mb-2 ">
                                    <asp:LinkButton ID="btnAddWorkOut" runat="server" OnClick="btnAddWorkOut_Click" CssClass="btnAddData">
                                                 <i class="fa fa-plus AddPlus"></i> </asp:LinkButton>
                                </div>
            ...
            <div class="DisplyCardPostion table-responsive">
                <div class="PageHeader" style="margin-top: -25px">
                    <h5>Food Item <span>List</span>
                          <asp:LinkButton  ID="btnFoodClose" CssClass="float-end btnclose"  OnClick="btnFoodClose_Click" runat="server"  >
        ...
        <div id="AddWorkOutPlan" runat="server" class="DisplyCard" visible="false">
            <div class="DisplyCardPostion1 table-responsive">
                <div class="PageHeader" style="margin-top: -25px">
                    <h5>Add WorkOutPlan <span>List</span>
                        <asp:LinkButton  ID="btnCloses" CssClass="float-end btnclose"  OnClick="btnCloses_Click" runat="server"  >
                              <i class="fa-solid fa-x"></i>
                        </asp:LinkButton>
                    ...
                    <div class="ddl">
                        <div class="row">
                            <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 mb-3">
                                <div id="divWorkOut" runat="server"></div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 mb-3" runat="server" visible="false">
                            ...
                            <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 ">
                                <div class="txtboxdiv">
                                    <asp:TextBox ID="txtWorKFromdate" TabIndex="4" CssClass="txtbox ConvertfromDate" runat="server" placeholder=" " />
                                    <asp:Label CssClass="txtlabel" runat="server">From Date<span class="reqiredstar">*</span></asp:Label>
                            ...
                            <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                <div class="txtboxdiv">
                                    <asp:TextBox ID="txtWorkTodate" TabIndex="5" CssClass="txtbox ConverttoDate" runat="server" placeholder=" " />
                                    <asp:Label CssClass="txtlabel" runat="server">To Date<span class="reqiredstar">*</span></asp:Label>
                        ...
                        <div class="row" id="divsubCategory" runat="server" visible="false">
                            <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 mb-3" >
                                <asp:Label ID="Label1" runat="server" Text="Work Outs" Style="font-size: 15px; font-weight: 700;margin-left: -121px;"></asp:Label>
                                <asp:CheckBoxList ID="chkSubCategory" TabIndex="6" runat="server" Style="font-size: 15px;text-align: initial;"
