...
<asp:Content ID="CntBooking" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="row enrollBg">
            <div class="col-12 col-sm-7 col-md-7 col-lg-7 col-xl-7">
                ...
                <div class="row">
                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 mb-3">
                        <div class="txtboxdiv">
                            <asp:TextBox ID="txtDOB" AutoComplete="off" ClientIDMode="Static" onchange="ageCalculator()" CssClass="txtbox fromDate" runat="server" TabIndex="8" placeholder=" " />
    ...
    <script>
        ...
        // document.getElementById("txtDOB").onchange = function () {
        function ageCalculator() {
            debugger
            var userinput = document.getElementById("txtDOB").value;
            var dob = new Date(userinput);
            if (userinput == null || userinput == '') {
                document.getElementById("RfvDOB").innerHTML = "**Choose a date please!";
                return false;
            } else {
                ...
                return document.getElementById("txtage").value = age;
            }
        }
    </script>
</asp:Content>
