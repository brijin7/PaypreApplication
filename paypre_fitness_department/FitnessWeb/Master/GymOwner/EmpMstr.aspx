...
<asp:Content ID="CntEmpMstr" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="PageRoute">
        <div>
            ...
            <i class="fafaicon">/</i>
            <asp:Label ID="lblNavSecond" runat="server" CssClass="pageRoutecol" Text="Admin Setup"></asp:Label>
            <i class="fafaicon">/</i>
            <asp:Label ID="lblNav3" runat="server" CssClass="pageRoutecol" Text="Admin Master"></asp:Label>
        </div>
    </div>
    <div class="container-fluid frmcontainer">
        <div id="DivForm" runat="server" visible="false">
            <div class="PageHeader">
                <h5>Admin <span>Master</span></h5>
            </div>
                        ...
                        <asp:TemplateField HeaderText="Edit" HeaderStyle-CssClass="gvHeader">
                            <ItemTemplate>
                                <asp:ImageButton
                                    ...
                                    Text="Edit"
                                    Visible='<%#Eval("activeStatus").ToString() =="A"?true:false%>' CausesValidation="false" OnClick="LnkEdit_Click" />
                            </ItemTemplate>
